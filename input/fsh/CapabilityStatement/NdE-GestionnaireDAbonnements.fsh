...
// * rest[=].resource.profile = "http://esante.gouv.fr/ci-sis/fhir/StructureDefinition/NdE_NotificationRequestNdE" Modifier avec le bon url
...
// * rest[=].resource[=].profile = "http://esante.gouv.fr/ci-sis/fhir/StructureDefinition/NdE_SubscriptionNdE" Modifier avec le bon url
